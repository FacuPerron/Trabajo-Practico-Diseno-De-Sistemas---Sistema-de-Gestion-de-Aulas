# Sistema de Gestion de Aulas TP-DDS
Trabajo práctico grupal de la materia Diseño de Sistemas.

##  Descripción
Sistema desarrollado para la gestión de aulas en una institución académica, permitiendo administrar reservas, disponibilidad y características de las mismas según distintos requerimientos.
...
### Cómo ejecutar:
   #### git clone https://github.com/AuDuarte/TP-DDS-2024
   #### mvn clean install
   #### mvn exec:java
